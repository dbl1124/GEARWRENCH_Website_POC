...
const categories = [
    ...
    { title: "Sets", image: "/images/MHT-cat.jpg", link: "/category/sets", imageClass: "object-contain scale-[2.0] group-hover:scale-[2.1]" },
    { title: "Sockets", image: "/images/socket-cat.jpg", link: "/category/sockets", imageClass: "object-contain scale-[2.0] group-hover:scale-[2.1]" },
    { title: "Ratchets", image: "/images/ratchet-cat.jpg", link: "/category/ratchets", imageClass: "object-contain scale-[4.15] group-hover:scale-[4.25] rotate-[30deg] group-hover:rotate-[35deg] translate-y-[260px] group-hover:translate-y-[255px] translate-x-[170px] group-hover:translate-x-[165px]" },
    { title: "Extraction", image: "/images/extract-cat.jpg", link: "/category/extraction", imageClass: "object-contain scale-[2.0] group-hover:scale-[2.1] translate-x-[10px] group-hover:translate-x-[5px]" },
    { title: "Pliers", image: "/images/plier-cat.jpg", link: "/category/pliers", imageClass: "object-contain scale-[2.6] group-hover:scale-[2.7] translate-x-[50px] group-hover:translate-x-[45px] -translate-y-[20px] group-hover:-translate-y-[25px]" },
];
    ...
    return (
        <section className="w-full py-16 bg-white font-sans overflow-hidden">
            <div className="max-w-[1480px] mx-auto px-6 mb-10 w-full">
                {/* Header left-aligned to the 1480px global rail */}
                <h2 className="text-3xl md:text-4xl font-black text-brand-black uppercase tracking-tight m-0">
                    Featured Categories
                </h2>
                {/* Thick Orange Underline Accent */}
                <div className="h-1.5 bg-brand-orange mt-2 w-48 hidden md:block" />
                <div className="h-1.5 bg-brand-orange mt-2 w-32 md:hidden" />
            </div>
                ...
                >
                    ...
                    {categories.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="absolute top-0 inset-x-0 bottom-[100px] mix-blend-multiply flex items-center justify-center p-4">
                                <Image
                                    src={item.image}
                                    alt={item.title}
                                    fill
